    ...
    <div className="rounded-2xl bg-white dark:bg-white/[0.03] min-h-[calc(100vh-200px)] pb-[1.5rem]">
      <div className="min-w-full">
        <Table>
          <TableHeader className="bg-[#FAFAFA] border-gray-100 dark:border-gray-800 border-b px-[1rem]">
            <TableRow>
              <TableCell isHeader className="py-3 px-3 text-start text-base font-medium text-[#201D1D99] dark:text-white min-w-[10rem]">
                Users
              </TableCell>
              <TableCell isHeader className="py-3 px-3 text-center text-base font-medium text-[#201D1D99] dark:text-white min-w-[10rem]">
                Social Handles
              </TableCell>
              <TableCell isHeader className="py-3 px-3 text-start text-base font-medium text-[#201D1D99] dark:text-white min-w-[10rem]">
                Audience
              </TableCell>
              <TableCell isHeader className="py-3 px-3 text-start text-base font-medium text-[#201D1D99] dark:text-white min-w-[15rem]">
                Description
              </TableCell>
              <TableCell isHeader className="py-3 px-3 text-start text-base font-medium text-[#201D1D99] dark:text-white min-w-[12rem]">
                Badges
              </TableCell>
              <TableCell isHeader className="flex items-center justify-center py-3 px-3 text-center text-base font-medium text-[#201D1D99] dark:text-white min-w-[3.75rem]">
                Status
                <div className="flex justify-end pl-4 py-0">
                  <select
                    value={filterStatus}
                  ...
                  <TableCell className="px-3 py-[1.25rem] text-[#201D1D] text-base dark:text-white/90 text-center min-w-[3.75rem] flex items-center justify-center h-[6rem]">
                    {kol?.status === "pending" ? (
                      ...
                      <span
                        className="capitalize flex items-center justify-center text-xs h-[1.5rem] w-[5rem] rounded-md"
                        style={{
                          background: kol.status === "approved" ? "#7BD481" : "#FF3737",
                          color: "#fff",
                        }}
                      >
                        {kol.status.toLowerCase()}
