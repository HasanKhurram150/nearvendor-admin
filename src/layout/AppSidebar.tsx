...
const AppSidebar: React.FC = () => {
        ...
        <li key={nav.name}>
          {nav.subItems ? (
            <button
              ...
              className={`menu-item group rounded-3xl  ${
            ...
            nav.path && (
              <Link
                href={nav.path}
                className={`menu-item group rounded-[5rem] ${
  ...
  const handleSubmenuToggle = (index: number, menuType: "main" | "inventory") => {
      ...
      <div className="flex flex-col overflow-y-auto duration-300 ease-linear no-scrollbar">
        <nav className="mb-6">
          <div className="flex flex-col gap-4">
            ...
            <div className="">
              <p
                className={`mb-4 text-base flex leading-[20px] text-black ${
                  !isExpanded && !isHovered
                    ? "lg:justify-center"
                    : "justify-start"
                }`}
